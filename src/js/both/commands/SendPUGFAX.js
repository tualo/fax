Ext.define('Tualo.cmp.mail.commands.SendPUGFax', {
  ...
  run: async function () {
    ...
    if (Ext.isEmpty(o.to)) {
      Ext.toast({
        html: 'Bitte geben Sie eine Zielnummer an.',
        title: 'Fehler',
        align: 't',
        iconCls: 'fa fa-warning'
      });
    ...
    if (Ext.isEmpty(this.record.get('__sendfax_reference'))) {
      Ext.toast({
        html: 'Das Feld "__sendfax_reference" fehlt.',
        title: 'Fehler',
        align: 't',
        iconCls: 'fa fa-warning'
      });
    ...
    let res = await fetch('./fax/' + this.record.get('__table_name') + '/' + this.record.get('__sendfax_template') + '/' + this.record.get('__id') + '/' + o.to + '/' + (this.record.get('__sendfax_reference') || ''), {
      method: 'get',
